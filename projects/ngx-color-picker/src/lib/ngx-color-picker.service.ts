...
export class NgxColorPickerService {
  private active: NgxColorPickerComponent | null = null;

  constructor() { }

  setActive(active: NgxColorPickerComponent | null): void {
  ...
  stringToHsva(colorString: string = '', allowHex8: boolean = false): Hsva | null {
