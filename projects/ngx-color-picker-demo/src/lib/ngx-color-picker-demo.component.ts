...
import { NgxColorPickerService, Cmyk } from 'ngx-color-picker';

@Component({
  selector: 'lib-ngx-color-picker-demo',
  templateUrl: 'ngx-color-picker-demo.component.html',
  styles: []
})
export class NgxColorPickerDemoComponent implements OnInit {
  ...
  constructor(public vcRef: ViewContainerRef, private cpService: NgxColorPickerService) { }
