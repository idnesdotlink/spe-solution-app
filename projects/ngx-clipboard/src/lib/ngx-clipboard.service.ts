...
export class ClipboardService {
  ...
  copyResponse$: Observable<IClipboardResponse> = this.copySubject.asObservable();
   ...
   */
  copyFromContent(content: string, container: HTMLElement = this.window.document.body) {
  ...
  destroy(container: HTMLElement = this.window.document.body) {
    if (this.tempTextArea) {
   ...
   * to the response.
   */
  pushCopyReponse(response: IClipboardResponse) {
